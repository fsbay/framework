...
/**
 * 基于PKCS1规范的RSA私钥签名SHA-1实现
 *
 * @author dengzhineng
 * @mail zhineng.deng@163.com
 * @date: 2019年6月15日 上午8:40:37
 * @version 1.0
 * @since JDK 1.8
 */
public class SHA1withRSAPKCS8Sign extends BaseSign {

    private PrivateKey privateKey;

    public SHA1withRSAPKCS8Sign() {
    }
     ...
     * @throws Exception
     */
    public SHA1withRSAPKCS8Sign(String rsaPrivateKey) throws Exception {
        init(rsaPrivateKey);
    }

    public SHA1withRSAPKCS8Sign(byte[] bytes) throws Exception {
        init(bytes);
    }
